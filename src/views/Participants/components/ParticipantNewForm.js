...
import ParticipantGroupsSelector from '../../../utils/GroupsSelector';
...
const ParticipantNewForm = props => {
  ...
  const submitData = async () => {
    ...
    handleSuccessToastr('Participant created successfully', () =>
      props.CloseModal()
    );
  };
      ...
      <div>
        ...
        <form
          ...
          <TextField
            ...
            inputRef={register}
            fullWidth
            label={<Typography variant="body2">Place of Living *</Typography>}
            name="placeOfLiving"
            autoFocus
          />
