...
import { Table, ModeratorsToolbar } from './components/index';
...
const ModeratorsTable = props => {
  ...
  const renderUserTable = () => {
    ...
    return <Table users={moderatorsList} />;
  };
...
export default connect(mapStateToProps, { fetchModerators })(ModeratorsTable);
